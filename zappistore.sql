...
(2, 'impackt lite', 'mmr impackt bestsell pack', 'impackt', 'impackt lite<br/>by mmr', '"Lorem ipsum dolor sit amet,<br/>consectetur adipiscing elit"', '"Sed ut perspiciatis, unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam eaque ipsa, quae"'),
